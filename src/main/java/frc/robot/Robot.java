...
public class Robot extends TimedRobot {
  ...
   */
  CANSparkBase m_launchWheel = new CANSparkMax(2, MotorType.kBrushed);
  CANSparkBase m_feedWheel = new CANSparkMax(4, MotorType.kBrushed);

  /**
   * Roller Claw motor controller instance.
  */
  CANSparkBase m_rollerClaw = new CANSparkMax(6, MotorType.kBrushed);
  /**
